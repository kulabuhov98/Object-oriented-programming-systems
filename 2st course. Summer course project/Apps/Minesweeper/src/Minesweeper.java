...
public class Minesweeper extends JFrame {
    ...
    private void initJMenuBar() {
        ...
        /* Регистрация слушателя события основного элемента Help в меню */
        helpJMenu.addActionListener(e -> {
            /* Вызов метода initJOptionPane класса Main */
            initJOptionPane("Игрок открывает ячейки, стараясь не открыть ячейку с миной. " +
                    "Открыв ячейку с миной, он проигрывает. " +
                    "Если под открытой ячейкой мины нет, то в ней появляется число, показывающее, " +
                    "сколько ячеек, соседствующих с только что открытой, «заминировано» " +
                    "(в каждом варианте игры соседство определяется по-своему); используя эти числа, " +
                    "игрок пытается рассчитать расположение мин, однако иногда даже в середине и в конце " +
                    "игры некоторые ячейки всё же приходится открывать наугад. Если под соседними ячейками " +
                    "тоже нет мин, то открывается некоторая «не заминированная» область до ячеек, в которых " +
                    "есть цифры. «Заминированные» ячейки игрок может пометить, чтобы случайно не открыть их. " +
